...
class Framework(Base):
    ...
    framework_type: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class FrameworkClause(Base):
    ...
    parent: Mapped[FrameworkClause | None] = relationship(
        back_populates="children",
        remote_side="FrameworkClause.id",
        foreign_keys="FrameworkClause.parent_clause_id",
    )
    source_mappings: Mapped[list[ControlMapping]] = relationship(
        foreign_keys="ControlMapping.source_clause_id",
        lazy="noload",
        cascade="all, delete-orphan",
    )
    target_mappings: Mapped[list[ControlMapping]] = relationship(
