...
# Import cross-service models to resolve FK references
# TODO: Phase 2 — remove direct model imports, use API calls
from .cross_deps import vendor_models as _vendor_deps  # noqa: F401
from .cross_deps import admin_models as _admin_deps  # noqa: F401
from .cross_deps import auth_models as _auth_deps  # noqa: F401
from .cross_deps.admin_models import AuditLog  # TODO: Replace with API call in Phase 2
from .cross_deps.auth_models import User  # TODO: Replace with API call in Phase 2
from .cross_deps.communication_models import (  # TODO: Replace with API call in Phase 2
    EmailTemplate,
    Notification,
)
from .models import (
